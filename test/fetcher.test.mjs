...
describe('createFetcher', () => {
  ...
  it('throttles when rate limit remaining drops below threshold', async () => {
    const sleepCalls = [];
    // 3 pages: page1 (full, low remaining → sleep), page2 (full, low remaining → sleep), page3 (partial, stop)
 ...
 * @param {string[]} [remainingPerPag]e - x-ratelimit-remaining values per page
 */
